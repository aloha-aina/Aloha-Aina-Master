...
## merging all climate model future/historical ratios for December 19th storm (note: you will need to have run climate_change_analysis.Rmd for all climate models) to plot 
```{r}
futhis_ratio_combine_dec19 <- merge_his_proj_filt_dec19 %>%
  rbind(bcc_merge_his_proj_filt_dec19, ipsl_merge_his_proj_filt_dec19) %>% 
  mutate(model = c("CNRM"))

futhis_ratio_combine_dec19$model[c(5:8)] = "BCC"
futhis_ratio_combine_dec19$model[c(9:12)] = "IPSL"

cbp2 <- c("#000000", "#009E73",
           "#D55E00")

combine_ratio_plot_dec19 <- ggplot(data = futhis_ratio_combine_dec19, aes(x=ssp, y=fut_hist_ratio)) +
...
combine_ratio_plot_dec19

  #  ggsave('combine_ratio_plot_dec19.png', combine_ratio_plot_dec19, width = 12, height = 10, units = "in")
...
combine_ratio_plot_mar14
   ...
   # ggsave('combine_ratio_plot_mar14.png', combine_ratio_plot_mar14, width = 12, height = 10, units = "in")
