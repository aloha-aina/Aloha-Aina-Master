...
subcatch_max_peak <- subcatch_max %>% 
  ...
  theme_bw() + 
  scale_fill_gradient(low = "#D1F2EB", high = "#148F77", name = "Peak Runoff (cfs)",
...
# ggsave('subcatch_max_peak_removedsubs.png', subcatch_max_peak, width = 5, height = 7, units = "in")
...
# ggsave('subcatch_min_peak_removedsub.png', subcatch_min_peak, width = 5, height = 7, units = "in")
