...
ggplot(data=dStandardNormal, aes(x=daily_pcp, y= Distribution)) +
  geom_line(size=1.5) +
  theme_minimal() +
  ...
  annotate("text", x = 4.75, y = 0.94, label = "Max MCF * avg pcp", color = "#D55E00") +
  annotate("text", x = 4.75, y = 0.91, label = "Min MCF * avg pcp", color = "#009E73") 
```
